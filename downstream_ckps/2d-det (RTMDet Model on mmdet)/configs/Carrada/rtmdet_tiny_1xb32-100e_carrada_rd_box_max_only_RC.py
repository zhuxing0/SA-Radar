...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        ann_file='train_rd_isim_only_mix_box_max_new.json'))
...
val_dataloader = dict(
    dataset=dict(
        ...
        metainfo=metainfo,
        data_prefix=dict(img=''),
        ann_file=data_root + '/test_rd_isim_only_mix_box_max_new.json'))

test_dataloader = val_dataloader

val_evaluator = dict(ann_file=data_root + '/test_rd_isim_only_mix_box_max_new.json')
