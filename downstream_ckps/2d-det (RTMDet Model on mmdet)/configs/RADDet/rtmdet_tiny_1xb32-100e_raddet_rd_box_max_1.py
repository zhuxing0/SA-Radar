...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        ann_file='train_rd_box_max_multi_1.json'))
...
val_dataloader = dict(
    dataset=dict(
        ...
        metainfo=metainfo,
        data_prefix=dict(img=''),
        ann_file=data_root + '/test_rd_box_max_multi_1.json'))

test_dataloader = val_dataloader

val_evaluator = dict(ann_file=data_root + '/test_rd_box_max_multi_1.json')
